...
TEST_CASE_MAP = {
    # --- Windows -------------------------------------------------------------
    "tests/windows/test_windows_system.py::TestWindowsSystem::test_windows_status": "TC-100",
    "tests/windows/test_windows_system.py::TestWindowsSystem::test_windows_cpu_info": "TC-101",
    "tests/windows/test_windows_system.py::TestWindowsSystem::test_windows_cpu_count_matches_config": "TC-102",
    "tests/windows/test_windows_system.py::TestWindowsSystem::test_windows_memory_info": "TC-103",
    "tests/windows/test_windows_system.py::TestWindowsUI::test_desktop_matches_baseline": "TC-104",
    "tests/windows/test_windows_system.py::TestWindowsUI::test_screenshot_is_captured": "TC-105",
    "tests/windows/test_windows_system.py::TestWindowsUI::test_resolution_matches_config": "TC-106",
    "tests/windows/test_windows_system.py::TestWindowsUI::test_input_injection_works": "TC-107",
    ...
    # --- Astra Linux ---------------------------------------------------------
    "tests/Astra/test_astra_system.py::TestAstraSystem::test_astra_status": "TC-108",
    "tests/Astra/test_astra_system.py::TestAstraSystem::test_astra_cpu_info": "TC-109",
    "tests/Astra/test_astra_system.py::TestAstraSystem::test_astra_cpu_count_matches_config": "TC-110",
    "tests/Astra/test_astra_system.py::TestAstraSystem::test_astra_memory_info": "TC-111",
    "tests/Astra/test_astra_system.py::TestAstraUI::test_desktop_matches_baseline": "TC-112",
    "tests/Astra/test_astra_system.py::TestAstraUI::test_screenshot_is_captured": "TC-113",
    "tests/Astra/test_astra_system.py::TestAstraUI::test_resolution_matches_config": "TC-114",
    "tests/Astra/test_astra_system.py::TestAstraUI::test_input_injection_works": "TC-115",
    ...
    "tests/Astra/test_astra_menu_quick_settings.py::TestAstraMenuQuickSettings::test_quick_capture_settings": "TC-94",
    "tests/Astra/test_astra_menu_auto_capture.py::TestAstraMenuAutoCapture::test_auto_capture_settings": "TC-97",
    # --- macOS ---------------------------------------------------------------
