...
# запуск с заставкой и окном восстановления. Замер 23.07.2026: тело теста 65с,
# и это с одним сработавшим повтором клика; каждый неудавшийся повтор кнопки
# мастера добавляет до 15с. Прогонщики (run_tests.py, консоль, режим
# разработчика) передают общий таймаут в командной строке, и тест падал по нему
# при полностью исправном сценарии. 300с — заведомо выше реального худшего
# случая, но всё ещё ловит настоящее зависание.
